...
public class GildedRoseTest {
    ...
    class ItemQualityUpdateTests {
        ...
        class StandardItemTests {
            ...
            public void test1() {
                app.items.add(new Item("Standard Item", 5, 10));
                app.updateQuality();
            ...
            public void test2() {
                app.items.add(new Item("Standard Item", 0, 10));
                app.updateQuality();
        ...
        class MaturingItemTests {
            ...
            public void test1() {
                app.items.add(new Item("Aged Brie", 10, 10));
                app.updateQuality();
            ...
            public void test2() {
                app.items.add(new Item("Aged Brie", 0, 10));
                app.updateQuality();
            ...
            public void test3() {
                app.items.add(new Item("Aged Brie", 0, 50));
                app.updateQuality();
        ...
        class ConcertItemTests {
            ...
            public void test1() {
                app.items.add(new Item("Backstage passes to a TAFKAL80ETC concert", 15, 10));
                app.updateQuality();
                assertEquals(11, app.items.get(0).quality);
            }
            ...
            public void test2() {
                app.items.add(new Item("Backstage passes to a TAFKAL80ETC concert", 8, 10));
                app.updateQuality();
                assertEquals(12, app.items.get(0).quality);
            }
            ...
            public void test3() {
                app.items.add(new Item("Backstage passes to a TAFKAL80ETC concert", 5, 10));
                app.updateQuality();
            ...
            public void test4() {
                app.items.add(new Item("Backstage passes to a TAFKAL80ETC concert", 0, 10));
                app.updateQuality();
                assertEquals(0, app.items.get(0).quality);
            }
            ...
            public void test5() {
                app.items.add(new Item("Backstage passes to a TAFKAL80ETC concert", 4, 50));
                app.updateQuality();
                assertEquals(50, app.items.get(0).quality);
            }
