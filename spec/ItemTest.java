    ...
    class ItemQualityUpdateTests {
        ...
        class QualityAlteringItemTests {
            ...
            class StandardItemTests {
                ...
                @Nested
                @DisplayName("ConjuredItemTests")
                class ConjuredItemTests {

                    @Test
                    @DisplayName("A conjured item should have it's quality decrease by 2 when updated" +
                            "while still only having it's sellIn decrease by 1")
                    public void test1() {
                        app.items.add(new ConjuredItem("Standard Item", 4, 10));
                        app.dayPasses();
                        assertEquals(8, app.items.get(0).quality);
                    ...
                    @Test
                    @DisplayName("A conjured item should have it's quality decrease by 4 when past it's sellby date" +
                            "while still only having it's sellIn decrease by 1")
                    public void test2() {
                        app.items.add(new ConjuredItem("Standard Item", 0, 10));
                        app.dayPasses();
